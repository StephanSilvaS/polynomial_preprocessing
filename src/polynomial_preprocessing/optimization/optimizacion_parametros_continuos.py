...
class OptimizacionParametrosContinuos:
	def __init__(self, fits_path, ms_path, poly_limits, division_limits):
		self.fits_path = fits_path
		self.ms_path = ms_path
		self.poly_limits = poly_limits
		self.division_limits = division_limits
	...
	def optimize_parameters(self, trial):
		...
		N1 =  fits_dimensions[1]   # Numero de pixeles
		...
		data_processing = procesamiento_datos_continuos.ProcesamientoDatosContinuos(self.fits_path, self.ms_path, S, division)
