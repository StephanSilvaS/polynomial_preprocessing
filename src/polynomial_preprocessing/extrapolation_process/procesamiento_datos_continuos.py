...
class ProcesamientoDatosContinuos:
	def __init__(self, fits_path, ms_path, num_polynomial, division_sigma, pixel_size = None, image_size = None, n_iter_gc = 15, verbose = True, plots = False):
		...
		if self.pixel_size is None:
			...
			pixel_deg = pixels_size * unit.deg

			# Convertir grados a arcosegundos
			pixel_size_arcseg = pixel_deg * unit.deg.to(unit.arcsec)

			print("Pixel size of FITS on arcseg: ", pixel_size_arcseg)
			self.pixel_size = pixel_size_arcseg
