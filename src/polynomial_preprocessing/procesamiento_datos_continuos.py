...
class ProcesamientoDatosContinuos:
	def __init__(self, fits_path, ms_path, num_polynomial, division_sigma, dx = None):
...
ejemplo1 = ProcesamientoDatosContinuos("dirty_images_natural_251.fits", "hd142_b9cont_self_tav.ms", 11, 0.014849768613424696, 0.0007310213536)
